		...
		!((e, t) => {
			"object" == typeof exports && "object" == typeof module
				...
				: "function" == typeof define && define.amd
					? define("Typewriter", ["react"], t)
					: "object" == typeof exports
						? (exports.Typewriter = t(require_react()))
			...
			(() => {
				var t = {
						...
						79: (e2, t2, r2) => {
							...
							function u(e3) {
								var t3 = -1,
									r3 = null == e3 ? 0 : e3.length
								for (this.clear(); ++t3 < r3; ) {
									var n3 = e3[t3]
									this.set(n3[0], n3[1])
								}
							}
							;(u.prototype.clear = n2),
								(u.prototype.delete = o2),
								(u.prototype.get = a),
								(u.prototype.has = i),
								(u.prototype.set = s),
								(e2.exports = u)
						...
						80: (e2, t2, r2) => {
							var n2 = r2(6025),
								o2 = Array.prototype.splice
							e2.exports = function (e3) {
								var t3 = this.__data__,
									r3 = n2(t3, e3)
								return !(
									r3 < 0 || (r3 == t3.length - 1 ? t3.pop() : o2.call(t3, r3, 1), --this.size, 0)
								)
							}
						},
						270: (e2, t2, r2) => {
						...
						294: e2 => {
							e2.exports = e3 =>
								"number" == typeof e3 && e3 > -1 && e3 % 1 == 0 && e3 <= 9007199254740991
						},
						317: e2 => {
							e2.exports = e3 => {
								var t2 = -1,
						...
						346: e2 => {
							e2.exports = e3 => null != e3 && "object" == typeof e3
						},
						361: e2 => {
							var t2 = /^(?:0|[1-9]\d*)$/
							e2.exports = (e3, r2) => {
								var n2 = typeof e3
								return (
									!!(r2 = null == r2 ? 9007199254740991 : r2) &&
									("number" == n2 || ("symbol" != n2 && t2.test(e3))) &&
									e3 > -1 &&
									e3 % 1 == 0 &&
									e3 < r2
								)
						...
						392: e2 => {
							e2.exports = (e3, t2) => (null == e3 ? void 0 : e3[t2])
						},
						659: (e2, t2, r2) => {
							var n2 = r2(1873),
								o2 = Object.prototype,
						...
						1882: (e2, t2, r2) => {
							...
							e2.exports = e3 => {
								...
								return (
									"[object Function]" == t3 ||
									"[object GeneratorFunction]" == t3 ||
									"[object AsyncFunction]" == t3 ||
									"[object Proxy]" == t3
								)
							}
						},
						1986: (e2, t2, r2) => {
							var n2 = r2(1873),
								...
								s = r2(317),
								u = r2(4247),
								c = n2 ? n2.prototype : void 0,
								p = c ? c.valueOf : void 0
							e2.exports = (e3, t3, r3, n3, c2, l, f) => {
								switch (r3) {
						...
						2428: (e2, t2, r2) => {
							var n2 = r2(7534),
								...
								u = n2(
									...
									? n2
									: e3 => o2(e3) && i.call(e3, "callee") && !s.call(e3, "callee")
							e2.exports = u
						},
						2552: (e2, t2, r2) => {
							var n2 = r2(1873),
						...
						3146: (e2, t2, r2) => {
							for (
								var n2 = r2(3491),
									o2 = "undefined" == typeof window ? r2.g : window,
									a = ["moz", "webkit"],
									i = "AnimationFrame",
									s = o2["request" + i],
									u = o2["cancel" + i] || o2["cancelRequest" + i],
									c = 0;
								!s && c < a.length;
								c++
							)
								(s = o2[a[c] + "Request" + i]),
									(u = o2[a[c] + "Cancel" + i] || o2[a[c] + "CancelRequest" + i])
							if (!s || !u) {
								var p = 0,
									l = 0,
									f = [],
							...
							;(e2.exports = e3 => s.call(o2, e3)),
								(e2.exports.cancel = function () {
									u.apply(o2, arguments)
								}),
								(e2.exports.polyfill = e3 => {
								...
								"undefined" != typeof performance && null !== performance && performance.now
									...
									: "undefined" != typeof process && null !== process && process.hrtime
										? ((e2.exports = () => (t2() - a) / 1e6),
											...
											(a = o2 - i))
										: Date.now
											? ((e2.exports = () => Date.now() - n2), (n2 = Date.now()))
											: ((e2.exports = () => new Date().getTime() - n2),
						...
						3656: (e2, t2, r2) => {
							...
							var n2 = r2(9325),
								o2 = r2(9935),
								a = t2 && !t2.nodeType && t2,
								i = a && e2 && !e2.nodeType && e2,
								s = i && i.exports === a ? n2.Buffer : void 0,
								u = (s ? s.isBuffer : void 0) || o2
							e2.exports = u
						},
						3661: (e2, t2, r2) => {
							var n2 = r2(3040),
						...
						4218: e2 => {
							e2.exports = e3 => {
								var t2 = typeof e3
								return "string" == t2 || "number" == t2 || "symbol" == t2 || "boolean" == t2
									? "__proto__" !== e3
									: null === e3
							}
						},
						...
						4248: e2 => {
							e2.exports = (e3, t2) => {
								for (var r2 = -1, n2 = null == e3 ? 0 : e3.length; ++r2 < n2; )
									if (t2(e3[r2], r2, e3)) return true
								return false
							}
						},
						4335: e2 => {
							e2.exports = (e3, t2) => r2 => e3(t2(r2))
						},
						4509: (e2, t2, r2) => {
							var n2 = r2(2651)
							e2.exports = function (e3) {
						...
						4664: (e2, t2, r2) => {
							var n2 = r2(9770),
								...
								s = i
									? e3 => (null == e3 ? [] : ((e3 = Object(e3)), n2(i(e3), t3 => a.call(e3, t3))))
									: o2
							e2.exports = s
						},
						4739: (e2, t2, r2) => {
						...
						4894: (e2, t2, r2) => {
							var n2 = r2(1882),
								o2 = r2(294)
							e2.exports = e3 => null != e3 && o2(e3.length) && !n2(e3)
						},
						4901: (e2, t2, r2) => {
							var n2 = r2(2552),
								o2 = r2(294),
							...
							;(i["[object Float32Array]"] =
								...
								(i["[object Arguments]"] =
									...
									i["[object WeakMap]"] =
										false),
								(e2.exports = e3 => a(e3) && o2(e3.length) && !!i[n2(e3)])
						},
						5083: (e2, t2, r2) => {
							var n2 = r2(1882),
								o2 = r2(7296),
							...
							e2.exports = e3 => !(!a(e3) || o2(e3)) && (n2(e3) ? f : s).test(i(e3))
						},
						5288: e2 => {
							e2.exports = (e3, t2) => e3 === t2 || (e3 != e3 && t2 != t2)
						},
						5481: (e2, t2, r2) => {
						...
						5749: (e2, t2, r2) => {
							...
							e2.exports = function (e3, t3) {
								var r3 = this.__data__
								return (
									(this.size += this.has(e3) ? 0 : 1),
									(r3[e3] = n2 && void 0 === t3 ? "__lodash_hash_undefined__" : t3),
									this
								)
							}
						},
						5861: (e2, t2, r2) => {
							var n2 = r2(5580),
								...
								_ = c(s),
								g = u
							;((n2 && g(new n2(new ArrayBuffer(1))) != d) ||
								(o2 && g(new o2()) != p) ||
								(a && g(a.resolve()) != l) ||
								(i && g(new i()) != f) ||
								(s && g(new s()) != v)) &&
								(g = e3 => {
									var t3 = u(e3),
										r3 = "[object Object]" == t3 ? e3.constructor : void 0,
										n3 = r3 ? c(r3) : ""
									if (n3)
										switch (n3) {
											case h:
						...
						5950: (e2, t2, r2) => {
							var n2 = r2(695),
								o2 = r2(8984),
								a = r2(4894)
							e2.exports = e3 => (a(e3) ? n2(e3) : o2(e3))
						},
						6009: (e2, t2, r2) => {
							e2 = r2.nmd(e2)
							var n2 = r2(4840),
								o2 = t2 && !t2.nodeType && t2,
								a = o2 && e2 && !e2.nodeType && e2,
								i = a && a.exports === o2 && n2.process,
								s = (() => {
									try {
										return (
						...
						7068: (e2, t2, r2) => {
							...
							e2.exports = (e3, t3, r3, h, y, b) => {
								...
								if (E && !x)
									return (
										b || (b = new n2()),
										m || p(e3) ? o2(e3, t3, r3, h, y, b) : a(e3, t3, g, r3, h, y, b)
									)
								if (!(1 & r3)) {
									var O = x && d.call(e3, "__wrapped__"),
										T = j && d.call(t3, "__wrapped__")
									if (O || T) {
										var A = O ? e3.value() : e3,
											S = T ? t3.value() : t3
						...
						7296: (e2, t2, r2) => {
							var n2,
								o2 = r2(5481),
								a = (n2 = /[^.]+$/.exec((o2 && o2.keys && o2.keys.IE_PROTO) || ""))
									? "Symbol(src)_1." + n2
									: ""
							e2.exports = e3 => !!a && a in e3
						},
						7301: e2 => {
							e2.exports = e3 => t2 => e3(t2)
						},
						7473: e2 => {
						...
						7534: (e2, t2, r2) => {
							var n2 = r2(2552),
								o2 = r2(346)
							e2.exports = e3 => o2(e3) && "[object Arguments]" == n2(e3)
						},
						7670: (e2, t2, r2) => {
							var n2 = r2(2651)
							e2.exports = function (e3) {
						...
						9219: e2 => {
							e2.exports = (e3, t2) => e3.has(t2)
						},
						9325: (e2, t2, r2) => {
							var n2 = r2(4840),
								o2 = "object" == typeof self && self && self.Object === Object && self,
								a = n2 || o2 || Function("return this")()
							e2.exports = a
						},
						9350: e2 => {
							var t2 = Object.prototype.toString
							e2.exports = e3 => t2.call(e3)
						},
						9770: e2 => {
							e2.exports = (e3, t2) => {
						...
						9905: (e2, t2, r2) => {
							...
							var n2 = r2(3146),
								o2 = r2.n(n2)
							const a = e3 => new RegExp(/<[a-z][\s\S]*>/i).test(e3),
								i = (e3, t3) => Math.floor(Math.random() * (t3 - e3 + 1)) + e3
							...
							function g(e3, t3) {
								...
								if (Object.getOwnPropertySymbols) {
									...
									t3 && (n3 = n3.filter(t4 => Object.getOwnPropertyDescriptor(e3, t4).enumerable)),
										r3.push.apply(r3, n3)
								}
								return r3
							}
							...
							function x(e3) {
								return (
									...
									(e4 => {
										if (
											("undefined" != typeof Symbol && null != e4[Symbol.iterator]) ||
											null != e4["@@iterator"]
										)
							...
							function E(e3, t3) {
								for (var r3 = 0; r3 < t3.length; r3++) {
									...
									;(n3.enumerable = n3.enumerable || false),
										...
										Object.defineProperty(e3, T(n3.key), n3)
								}
							}
							function O(e3, t3, r3) {
								return (
							...
							const A = (() => {
								function e3(t4, r4) {
									...
									if (
										...
										O(this, "setupWrapperElement", () => {
											_2.state.elements.container &&
												((_2.state.elements.wrapper.className = _2.options.wrapperClassName),
												(_2.state.elements.cursor.className = _2.options.cursorClassName),
												(_2.state.elements.cursor.innerHTML = _2.options.cursor),
												(_2.state.elements.container.innerHTML = ""),
												_2.state.elements.container.appendChild(_2.state.elements.wrapper),
												_2.state.elements.container.appendChild(_2.state.elements.cursor))
										}),
										O(
											this,
											"start",
											() => ((_2.state.eventLoopPaused = false), _2.runEventLoop(), _2),
										),
										O(this, "pause", () => ((_2.state.eventLoopPaused = true), _2)),
										O(
											this,
											"stop",
											() => (
												_2.state.eventLoop &&
													((0, n2.cancel)(_2.state.eventLoop), (_2.state.eventLoop = null)),
												_2
											),
										),
										O(this, "pauseFor", e4 => (_2.addEventToQueue(l, { ms: e4 }), _2)),
										O(this, "typeOutAllStrings", () =>
											"string" == typeof _2.options.strings
												? (_2.typeString(_2.options.strings).pauseFor(_2.options.pauseFor), _2)
												: (_2.options.strings.forEach(e4 => {
														_2.typeString(e4)
															.pauseFor(_2.options.pauseFor)
															.deleteAll(_2.options.deleteSpeed)
													}),
													_2),
										),
										O(this, "typeString", function (e4) {
											...
											if (e4) {
												var r5 = (_2.options || {}).stringSplitter,
													n3 = "function" == typeof r5 ? r5(e4) : e4.split("")
										...
										O(this, "pasteString", function (e4) {
											var t5 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null
											return a(e4)
												? _2.typeOutHTMLString(e4, t5, true)
												: (e4 && _2.addEventToQueue(b, { character: e4, node: t5 }), _2)
										}),
										O(this, "typeOutHTMLString", function (e4) {
											var t5 =
													arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
												r5 = arguments.length > 2 ? arguments[2] : void 0,
												n3 = (e5 => {
										...
										O(this, "addReverseCalledEvent", function (e4, t5) {
											var r5 = arguments.length > 2 && void 0 !== arguments[2] && arguments[2]
											return _2.options.loop
												? _2.addEventToStateProperty(e4, t5, r5, "reverseCalledEvents")
												: _2
										}),
										O(this, "addEventToStateProperty", function (e4, t5) {
											var r5 = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
												n3 = arguments.length > 3 ? arguments[3] : void 0,
												o3 = { eventName: e4, eventArgs: t5 || {} }
											return (
												(_2.state[n3] = r5
													? [o3].concat(x(_2.state[n3]))
													: [].concat(x(_2.state[n3]), [o3])),
												_2
											)
										}),
										O(this, "runEventLoop", () => {
											...
											var e4 = Date.now(),
												t5 = e4 - _2.state.lastFrameTime
											if (!_2.state.eventQueue.length) {
												if (!_2.options.loop) return
												;(_2.state.eventQueue = x(_2.state.calledEvents)),
													(_2.state.calledEvents = []),
													(_2.options = w({}, _2.state.initialOptions))
											}
											if (
												((_2.state.eventLoop = o2()(_2.runEventLoop)), !_2.state.eventLoopPaused)
											) {
												...
												var r5,
													n3 = x(_2.state.eventQueue),
													a2 = n3.shift()
												if (
													!(
														t5 <=
														(r5 =
															a2.eventName === p || a2.eventName === u
																? "natural" === _2.options.deleteSpeed
																	? i(40, 80)
																	: _2.options.deleteSpeed
																: "natural" === _2.options.delay
																	? i(120, 160)
																	: _2.options.delay)
													)
												) {
													...
													switch (
														...
														case s: {
															var E2 = j2.character,
																O2 = j2.node,
																T2 = document.createTextNode(E2),
																A2 = T2
															_2.options.onCreateTextNode &&
																"function" == typeof _2.options.onCreateTextNode &&
																(A2 = _2.options.onCreateTextNode(E2, T2)),
																A2 &&
																	(O2
																		? O2.appendChild(A2)
																		: _2.state.elements.wrapper.appendChild(A2)),
																(_2.state.visibleNodes = [].concat(x(_2.state.visibleNodes), [
																	{
																		type: "TEXT_NODE",
																		character: E2,
																		node: A2,
														...
														case v: {
															var L = a2.eventArgs,
																k = L.node,
																D = L.parentNode
															D ? D.appendChild(k) : _2.state.elements.wrapper.appendChild(k),
																(_2.state.visibleNodes = [].concat(x(_2.state.visibleNodes), [
																	{
																		type: m,
																		node: k,
																		parentNode: D || _2.state.elements.wrapper,
																	},
																]))
															break
														}
														case c: {
															var M = _2.state.visibleNodes,
																R = j2.speed,
																F = []
															R &&
																F.push({
																	eventName: d,
																	eventArgs: { speed: R, temp: true },
																})
															...
															R &&
																F.push({
																	eventName: d,
																	eventArgs: {
																		speed: _2.options.deleteSpeed,
																		temp: true,
																	},
																}),
																n3.unshift.apply(n3, F)
															break
														}
														case p: {
															var I = a2.eventArgs.removingCharacterNode
															if (_2.state.visibleNodes.length) {
																var U = _2.state.visibleNodes.pop(),
																	H = U.type,
																	q = U.node,
																	B = U.character
																_2.options.onRemoveNode &&
																	"function" == typeof _2.options.onRemoveNode &&
																	_2.options.onRemoveNode({
																		node: q,
																		character: B,
																	}),
																	q && q.parentNode.removeChild(q),
																	H === m && I && n3.unshift({ eventName: p, eventArgs: {} })
															}
															break
														}
														case d:
														...
														case h:
															...
															break
														case y:
															;(_2.options.cursor = a2.eventArgs.cursor),
																(_2.state.elements.cursor.innerHTML = a2.eventArgs.cursor)
													}
													_2.options.loop &&
														(a2.eventName === p ||
															(a2.eventArgs && a2.eventArgs.temp) ||
															(_2.state.calledEvents = [].concat(x(_2.state.calledEvents), [a2]))),
														(_2.state.eventQueue = n3),
														(_2.state.lastFrameTime = e4)
												}
											}
										}),
										t4)
									...
									r4 && (this.options = w(w({}, this.options), r4)),
									...
									(r3 = [
										{
											...
											value: function () {
												...
												this.setupWrapperElement(),
													this.addEventToQueue(y, { cursor: this.options.cursor }, true),
													...
													!window ||
														...
														(t4 = document.createElement("style")).appendChild(
															document.createTextNode(e4),
														),
														document.head.appendChild(t4),
														(window.___TYPEWRITER_JS_STYLES_ADDED___ = true)),
													true === this.options.autoStart &&
						...
						function u(e3, t3) {
							for (var r3 = 0; r3 < t3.length; r3++) {
								...
								;(n2.enumerable = n2.enumerable || false),
									...
									Object.defineProperty(e3, v(n2.key), n2)
							}
						}
						function c(e3, t3) {
							return (
						...
						function f(e3) {
							return (
								(f = Object.setPrototypeOf
									...
									: e4 => e4.__proto__ || Object.getPrototypeOf(e4)),
								f(e3)
							)
						}
						function v(e3) {
						...
						var d = (e3 => {
							!((e4, t3) => {
								...
								;(e4.prototype = Object.create(t3 && t3.prototype, {
									...
									Object.defineProperty(e4, "prototype", { writable: false }),
									t3 && c(e4, t3)
							})(d2, e3)
							var n2,
								o2,
							...
							function d2() {
								...
								for (var o3 = arguments.length, i2 = new Array(o3), s2 = 0; s2 < o3; s2++)
									i2[s2] = arguments[s2]
								return (
									(t3 = p((e4 = a2.call.apply(a2, [this].concat(i2))))),
									(n3 = { instance: null }),
									(r3 = v((r3 = "state"))) in t3
								...
								(o2 = [
									{
										...
										value: function () {
											var t3 = new r2.default(this.typewriter, this.props.options)
											this.setState({ instance: t3 }, () => {
												var r3 = this.props.onInit
												r3 && r3(t3)
											})
										},
									},
									{
										...
										value: function (e4) {
											i()(this.props.options, e4.options) ||
												this.setState({
													instance: new r2.default(this.typewriter, this.props.options),
												})
										},
									},
									{
									...
									},
									{
										key: "render",
										value: function () {
											var r3 = this.props.component
											return t2().createElement(r3, {
												ref: t3 => (this.typewriter = t3),
