export function Contribute() {
  return (
    <section
      id="contribute"
      className="contribute-section relative overflow-hidden py-24 mt-16 border-t border-b border-[rgba(168,85,247,0.3)] bg-[linear-gradient(135deg,rgba(20,17,30,1)_0%,rgba(45,20,80,1)_100%)]"
    >
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-12">
          <div className="contribute-card flex flex-col items-center justify-center text-center px-8 py-12 rounded-3xl bg-white/[0.03] border border-white/10 backdrop-blur-md transition-transform duration-300">
            ...
            <p className="mb-8 text-white/80">
              A Juninhos é feita de pessoas para pessoas. Sua contribuição ajuda a manter servidores e infraestrutura
              gratuitos.
            </p>
            <a
          ...
          <div className="contribute-card flex flex-col items-center justify-center text-center px-8 py-12 rounded-3xl bg-white/[0.03] border border-white/10 backdrop-blur-md transition-transform duration-300">
            ...
            <p className="mb-8 text-white/80">
              Deseja apoiar a iniciativa, contratar talentos ou propor parcerias? Entre em contato com nossa gestão.
            </p>
            <a
