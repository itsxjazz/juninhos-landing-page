      ...
      <div className="container">
        <div className="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-12">
          <div className="contribute-card flex flex-col items-center justify-center text-center px-8 py-12 rounded-3xl bg-white/[0.03] border border-white/10 backdrop-blur-md transition-transform duration-300">
            <h2 className="section-title !text-[1.8rem] !mb-4 !text-white">
              Apoie nossa Causa
            </h2>
            <p className="mb-8 text-white/80">
              A Juninhos é feita de pessoas para pessoas! <br /> Sua
              contribuição ajuda a manter servidores e infraestrutura gratuitos.
            </p>
            <a
          ...
          <div className="contribute-card flex flex-col items-center justify-center text-center px-8 py-12 rounded-3xl bg-white/[0.03] border border-white/10 backdrop-blur-md transition-transform duration-300">
            ...
            <p className="mb-8 text-white/80">
              Deseja apoiar a iniciativa, contratar talentos ou propor
              parcerias? <br /> Entre em contato com nossa gestão.
            </p>
            <a
