          ...
          >
            ...
            <li className="max-md:w-full max-md:text-center">
              <button
                ...
                className="nav-cta !px-[1.1rem] !py-2 !text-[0.9rem] max-md:!w-[min(80%,300px)] max-md:mx-auto"
              >
                Entrar na Lista
              </button>
            </li>
