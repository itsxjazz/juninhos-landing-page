...
const SUPPORT_OPTIONS = [
  ...
  { value: 'Preciso de ajuda no roteiro', label: 'Preciso de ajuda no roteiro e/ou nos slides' },
  { value: 'Ajuda com a vergonha', label: 'Quero apoio para perder a vergonha' },
];
  ...
  return (
    <Modal open={instructorOpen} onClose={handleClose}>
      <div className="w-full">
        ...
        {successMessage ? (
          ...
          <>
            <p className="mb-8 text-center">
              Queremos mapear quem domina os assuntos que nossos squads precisam aprender. Se você tem algo a ensinar,
              preencha abaixo. A gente te ajuda com o roteiro se precisar!
            </p>
        ...
        {!successMessage && feedback && <Feedback message={feedback.message} type={feedback.type} />}
      </div>
    </Modal>
  );
}
