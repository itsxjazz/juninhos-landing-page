...
const MOCK_USER = {
	...
	squad: {
		name: "Phoenix",
		project: "Plataforma de Mentorias",
							...
							{[
								{
									...
									value: MOCK_USER.stats.aulasAssistidas,
									color: "text-primary",
								},
								{
									label: "Projetos",
									value: MOCK_USER.stats.projetosContribuidos,
									color: "text-cyan",
								},
								{
									label: "Anos na comunidade",
									value: MOCK_USER.stats.anosComunidade,
									color: "text-success",
								},
								{
									label: "Contribuições",
									value: MOCK_USER.stats.contribuicoes,
						...
						<section className="grid lg:grid-cols-3 gap-3">
							...
							<article className="card-item !p-5 lg:col-span-2">
								...
								<div className="grid grid-cols-3 gap-3 text-sm">
									<div>
										<div
											className="text-[0.65rem] uppercase tracking-wider text-text-muted/70"
											style={{ fontFamily: MONO }}
										>
											Líder
										</div>
								...
								<a
									href="#"
									className="group inline-flex items-center gap-1.5 mt-3 text-xs text-primary hover:text-cyan transition-colors uppercase tracking-wider"
									style={{ fontFamily: MONO }}
								>
									Ver squad{" "}
								...
								<div className="grid grid-cols-3 gap-2 text-center">
									<div>
										<div className="text-xl font-bold text-primary leading-none">
											{MOCK_USER.instructor.agendadas}
										</div>
									...
									<div>
										<div className="text-xl font-bold text-cyan leading-none">
											{MOCK_USER.instructor.ministradas}
										</div>
										<div className="text-[10px] text-text-muted mt-1 uppercase tracking-wider">
											Ministradas
										</div>
									...
									<div>
										<div className="text-xl font-bold text-amber-400 leading-none">
											{MOCK_USER.instructor.pendentes}
										</div>
										<div className="text-[10px] text-text-muted mt-1 uppercase tracking-wider">
											Pendentes
										</div>
								...
								<ul className="grid grid-cols-2 gap-1.5">
									{MOCK_USER.teamShortcuts.map(s => (
										<li key={s}>
											...
											>
												<span>{s}</span>
												<span className="text-primary group-hover:text-cyan group-hover:translate-x-1 transition-all text-xs">
													→
												</span>
											</a>
										</li>
